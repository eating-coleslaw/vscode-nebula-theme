...
export const workspaceColors: IWorkspaceColor[] = [
  ...
  { scope: "menu.background", color: "#1F2330E0" },
  ...
  { scope: "menu.selectionBorder", color: "#0F1320", materialize: true },
  { scope: "menubar.selectionBackground", color: "#899BBF3A" },
  { scope: "menubar.selectionForeground", color: "#FCF6FF" },
  { scope: "menubar.selectionBorder", color: "#0F1320", materialize: true },
